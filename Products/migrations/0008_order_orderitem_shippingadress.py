...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('Products', '0007_auto_20201018_2303'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_ordered', models.FloatField()),
                ('complete', models.BooleanField(blank=True, default=False, null=True)),
                ('transaction_id', models.CharField(max_length=200, null=True)),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Profile.profile')),
            ],
        ),
        migrations.CreateModel(
            name='ShippingAdress',
